...
- 系统：Ubuntu 22.04
- 公网 IP：120.77.145.202
- 登录用户：admin

云服务器正式访问时，Electron 前端请求：

```js
API_BASE_URL: "http://120.77.145.202"
```
...
```bash
cd /home/admin/petodo-pet-app/backend
python3 -m venv venv
...
```text
http://120.77.145.202:8001/health
```
...
[Service]
User=admin
WorkingDirectory=/home/admin/petodo-pet-app/backend
ExecStart=/home/admin/petodo-pet-app/backend/venv/bin/python -m uvicorn main:app --host 127.0.0.1 --port 8001
Restart=always
